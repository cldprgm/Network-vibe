...
export default function UserProfilePage() {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'posts' | 'comments'>('posts');
    ...
    return (
        <div className='flex'>
            <div className="w-full mt-18 min-w-0 bg-zinc-50 dark:bg-[var(--background)]">
                <div className="max-w-[800px] mx-auto">
                    ...
                    <div className="space-y-6 pb-8 md:p-0">
                        {activeTab !== 'overview' && (
                            <div className="flex h-8 items-center justify-between bg-white dark:bg-[var(--background)] pl-2 pt-4 rounded-lg ">
