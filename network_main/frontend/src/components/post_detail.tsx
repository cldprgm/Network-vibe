import { deleteVotePost, getPostDetail, votePost } from "@/services/api";
...
export default async function PostDetail ({params}: {params: {slug: string}}) {
    ...
    return(
        ...
        <div className='mt-2'>
            <div className="bg-white dark:bg-[var(--background)] transition rounded-2xl hover:shadow-2xl mx-auto w-full overflow-hidden">
