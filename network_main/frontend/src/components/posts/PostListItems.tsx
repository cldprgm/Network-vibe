...
export default function PostListItems({ post }: { post: Post }) {
    ...
    const toggleShareMenu = (e: React.MouseEvent) => {
        ...
        if (!isShareMenuOpen && postContainerRef.current && shareButtonRef.current) {
                        ...
                        <div className="w-full overflow-x-auto">
                            <div className="flex items-center sm:flex-nowrap gap-2 sm:gap-3 w-full">
                                ...
                                <button
                                    ...
                                    className="cursor-pointer flex items-center gap-1 bg-gray-200/20 hover:bg-gray-200/40 rounded-full px-3 py-1.5"
                                >
